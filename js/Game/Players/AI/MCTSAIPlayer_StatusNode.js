...
class MCTSAIPlayer_StatusNode{
    ...
    ChildrenWithUCTComparator(a,b){
        let AValue = a.GetRate() + 1.4142135623730950488016887242097 * Math.sqrt( Math.log2(a.ControlPlayer.StatusRoot.Total+1) / (a.Total+1) )
        let BValue = b.GetRate() + 1.4142135623730950488016887242097 * Math.sqrt( Math.log2(b.ControlPlayer.StatusRoot.Total+1) / (b.Total+1) )
